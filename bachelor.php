...
<body>
    ...
    <main id="main-bachelor">
        ...
        <p id="desc-bachelor">Il apprend à construire des systèmes (Informatique), à les protéger (Cybersécurité) et à les rendre intelligents (IA).</p>
        <div class="option">
            <div id="reseaux">
                <h3 id="title-reseaux">Bachelor 3 Admin Systèmes Réseaux</h3>
                <div class="container-bachelor">
            ...
            <div id="dev">
                ...
                <div class="container-bachelor">
                    <p class="paragraphe">Ce Bachelor nous forme dans 3 domaines : le développement Fullstack, l'IA générative et le DevOps.</p>
                    <p class="paragraphe">Nous apprenons à créer des applications complexes, à les booster à l'IA et à automatiser leur déploiement en production.</p>
                </div>
                <ul class="ul-list is-invisible">
    ...
    <script src="src/js/appBachelor.js"></script>
</body>
</html>